# bSim v1.24.16 - Modular Professional Logic Simulator
...
- **Multi-Tab Workspace**: (New in v1.24.16) Manage multiple independent circuit boards within a single project context, featuring isolated undo/redo stacks.
- **Split-Pane Editor**: (New in v1.24.16) Professional dual-pane editing environment for macro chips. Compare sub-circuits side-by-side or spawn external popup editors.
