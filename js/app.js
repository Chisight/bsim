...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.24.22 | SEC_ARCH_LEAD] - Semantic version increment following externalized sub-menu logic to resolve scope collisions.
    window.LOADED_BSIM_VERSION = "1.24.22";
