...
window.onload = () => {
    ...
    // [AUDIT: v1.26.26 | SEC_ARCH_LEAD] - Shifted vector extraction from raw CSS strings to absolute rendered integer offsets to bypass calc() parsing faults.
    window.LOADED_BSIM_VERSION = "1.26.26";
