...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.23.93 | SEC_ARCH_LEAD] - Semantic version increment following custom macro legacy port migration and routing sanitization.
    window.LOADED_BSIM_VERSION = "1.23.93";
