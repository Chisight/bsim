...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.24.17 | SEC_ARCH_LEAD] - Semantic version increment following manual routing persistence and asynchronous project export naming.
    window.LOADED_BSIM_VERSION = "1.24.17";
