 ...
 */
/**
 * [AUDIT: v1.23.80 | SEC_ARCH_LEAD] - Entry trace for main application bootstrap.
...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.23.80 | SEC_ARCH_LEAD] - Semantic version increment following canvas context menu configuration parity.
    window.LOADED_BSIM_VERSION = "1.23.80";
    ...
    // [AUDIT: v1.23.80 | SEC_ARCH_LEAD] - EXIT_TRACE: Application bootstrap sequence finalized.
};
