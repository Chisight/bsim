...
window.onload = () => {
    ...
    // [AUDIT: v1.26.27 | SEC_ARCH_LEAD] - Unified parametric selection-drag state machine and enforced perimeter edge-clamping physics for terminal relocation.
    window.LOADED_BSIM_VERSION = "1.26.27";
