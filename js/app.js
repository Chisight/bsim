...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.24.04 | SEC_ARCH_LEAD] - Semantic version increment following telemetry CLI expansion and live coordinate tracking.
    window.LOADED_BSIM_VERSION = "1.24.04";
