...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.24.18 | SEC_ARCH_LEAD] - Semantic version increment following terminal duplication prevention and window control hardening.
    window.LOADED_BSIM_VERSION = "1.24.18";
