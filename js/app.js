...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.24.16 | SEC_ARCH_LEAD] - Semantic version increment following iframe pointer-event masking for floating window drag stability.
    window.LOADED_BSIM_VERSION = "1.24.16";
