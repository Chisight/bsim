...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.24.05 | SEC_ARCH_LEAD] - Semantic version increment following debug terminal hotkey collision resolution and scope isolation.
    window.LOADED_BSIM_VERSION = "1.24.05";
