...
window.onload = () => {
    ...
    // [AUDIT: v1.26.10 | SEC_ARCH_LEAD] - Resolved geometry mapping for dynamic bounding box. Reinstated absolute deterministic tracking for internal wiring points and viewport labels.
    window.LOADED_BSIM_VERSION = "1.26.10";
