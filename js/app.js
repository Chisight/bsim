...
window.onload = () => {
     ...
     */
    // [AUDIT: v1.24.15 | SEC_ARCH_LEAD] - Semantic version increment following I/O port context menu rename geometry stabilization.
    window.LOADED_BSIM_VERSION = "1.24.15";
