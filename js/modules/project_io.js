    ...
    MigrationEngine: {
        ...
        migrate(data) {
            ...
            if (!fileVerStr) {
                ...
                fileVerStr = epoch === "modern" ? (window.LOADED_BSIM_VERSION || "1.27.26") : "1.0.0";
            ...
            try {
                ...
                const performSave = async () => {
                    ...
                    const project = { 
                        ...
                        meta: { version: (window.LOADED_BSIM_VERSION || "1.27.26") + "-Modular", exportedAt: new Date().toISOString() }
                    };
