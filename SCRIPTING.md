...
| `spawn` | Instantiate a component at (x, y) | `spawn NAND 100 200` |
...
# Spawn components for an SR-Latch
spawn NAND 100 -40   # node-1
spawn NAND 100 40    # node-2
spawn IN-1 0 -40     # node-3 (Set)
spawn IN-1 0 40      # node-4 (Reset)
spawn OUT-1 200 -40  # node-5 (Q)
spawn OUT-1 200 40   # node-6 (!Q)

# Wire the latch logic
wire node-3 out0 node-1 a
wire node-4 out0 node-2 b
wire node-1 out node-2 a
wire node-2 out node-1 b
wire node-1 out node-5 in0
wire node-2 out node-6 in0
